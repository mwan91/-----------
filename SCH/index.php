            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"> <!-- 메뉴 바-->
                <ul class="nav navbar-nav navbar-right">
                  <!-- <script> -->
                    ...
                    <li>
                      <!-- if(user_id == NULL) -->
                        <a class="page-scroll" href="./register.html">Register</a> <!-- login.html <- login -->
                    </li>
                   <!-- </script> -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">이용가능 서비스</h2>
                    <hr class="primary">
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>캔버스 기능</h3>
                        <p class="text-muted">캔버스 기능을 통해 자소서 내용 첨삭이 가능합니다</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>온라인 저지</h3>
                        <p class="text-muted">온라인 저지를 통해 실시간 코딩이 가능합니다</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
        ...
        <div class="container-fluid">
            <div class="row no-gutter popup-gallery">
                <div class="col-lg-4 col-sm-6">
                    <a href="img/portfolio/fullsize/1.jpg" class="portfolio-box">  <!-- <a href="img/portfolio/fullsize/1.jpg">-->
    ...
    <aside class="bg-dark"> <!-- 로그인 버튼 -->
        <div class="container text-center">
            <div class="call-to-action">
                ...
                <a href="./login.html" class="btn btn-default btn-xl sr-button" onclick='alert("로그인 후 이용가능합니다.")'>START</a>
            </div>
        </div>
    </aside>
